...
and 
$$
  c_{t+1} = \left[\beta\cdot (1-\tau_k)\cdot\frac{1 + \alpha k_{t+1}^{\alpha-1} - \delta}{1+g}\right]^\gamma\cdot c_t.
$$
...
Our next fiscal policy exercise is to impose a tax on capital income of $\tau_k = 0.025$. We do this in quite a similar way as our government spending exercises.
